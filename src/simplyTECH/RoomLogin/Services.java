...
//					myFrame.getContentPane().add(panel);
	...
	private JButton getJButtonAlarmClock() {
		if (jButtonAlarmClock == null) {
			...
			jButtonAlarmClock.setLocation(new Point(546, 369));
			...
			jButtonAlarmClock.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					//System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
...
//					myFrame.getContentPane().add(panel);
	...
	private JButton getJButtonPointRewardSystem() {
		if (jButtonPointRewardSystem == null) {
			...
			jButtonPointRewardSystem.setLocation(new Point(263, 367));
			...
			jButtonPointRewardSystem.setText("Points Reward System");
			jButtonPointRewardSystem.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					//System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
	...
	private void initialize() {
		...
		jLabelServiceBackground = new JLabel();
		jLabelServiceBackground.setBounds(new Rectangle(594, 0, 427, 256));
		jLabelServiceBackground.setIcon(new ImageIcon(getClass().getResource(
				"/simplyTECH/image/Services.png")));
		jLabelServiceBackground.setText("");
		...
		this.add(jLabelServiceBackground, null);
