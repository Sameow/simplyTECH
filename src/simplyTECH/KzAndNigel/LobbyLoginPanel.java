...
public class LobbyLoginPanel extends JPanel {
	...
	private void initialize() {
		...
		jLabel1.setIcon(new ImageIcon(getClass().getResource("/simplyTECH/image/CheckmateBySimplyTECH.png")));
		jLabel1.setText("");
		jLabel = new JLabel();
		jLabel.setBounds(new Rectangle(469, -5, 504, 317));
		jLabel.setIcon(new ImageIcon(getClass().getResource("/simplyTECH/image/Capture2.PNG")));
		jLabel.setText("");
